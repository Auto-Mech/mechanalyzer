...
# ADD STEREOCHEMISTRY TO SPECIES AND REACTIONS
sorted_idx, cmts_dct, spc_dct = mechanalyzer.parser.mech.sort_mechanism(
    mech_info, spc_dct_full, SORT_STR, ISOLATE_SPECIES)

# WRITE THE NEW MECHANISM THAT IS EXPANDED BY STEREOCHEMISTRY
mechanalyzer.parser.mech.write_mech(
    elem_tuple, spc_dct, rxn_param_dct, SORTMECH_NAME, comments=cmts_dct)
