...
MECH_NAME = 'sorted_mech_IC8_cl_species.txt'
SORTMECH_NAME = 'class_sorted.txt'
# ISOLATE_SPECIES = ['IC8', 'IC8-1R', 'IC8-3R', 'IC8-4R', 'IC8-5R'] 
# LIST OF SPECIES TO BE INCLUDED IN THE MECH; IF EMPTY: PROCESS THE FULL MECH
ISOLATE_SPECIES = ['IC8'] # leave empty if you want to process the full mechanism
# SORT_STR = ['SPECIES', 0] # LIST WITH SORTING CRITERIA IN HIERARCHICAL ORDER
SORT_STR = ['RXN_CLASS_GRAPH', 'SPECIES', 0] # LIST WITH SORTING CRITERIA IN HIERARCHICAL ORDER
