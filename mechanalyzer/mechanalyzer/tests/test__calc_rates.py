...
ARRHENIUS_RXN_PARAM_DCT = {LOW_P_RXN:
                           ((LOW_P_PARAMS, None, None, None, None, None),)}
ARRHENIUS_KTS = np.array([8.8273E+1, 2.0086E+6, 3.0299E+8])

LINDEMANN_RXN_PARAM_DCT = {HIGH_P_RXN:
                           ((HIGH_P_PARAMS, LOW_P_PARAMS, None, None, None, None),)}
LINDEMANN_10ATM_KTS = np.array([7.6096e-03, 1.3922e+02, 1.6753e+04])

TROE_RXN_PARAM_DCT = {HIGH_P_RXN:
                           ((HIGH_P_PARAMS, LOW_P_PARAMS, [1.18, 1E-30, 7900], None, None, None),)}
TROE_10ATM_KTS = np.array([7.76752254e-03, 1.37906401e+02, 1.62555727e+04])

PLOG_RXN_PARAM_DCT = {HIGH_P_RXN:
...
CHEBYSHEV_RXN_PARAM_DCT = {HIGH_P_RXN:
                ((LOW_P_PARAMS, None, None, {'t_limits': [300.0, 2500.0],
                    'p_limits': [1.0, 100.0], 'alpha_elm': np.array([
                    [1.0216E+01, -1.1083E+00, -1.9807E-01],  # values from Bozzelli (2002)
                    [7.8325E-01, 1.1609E+00, 1.1762E-01],    # for C2H5 + O2 = C2H4 + HO2
...
CHEBYSHEV_100ATM_KTS = np.array([1.23879008e+07, 2.77379527e+08, 2.31421081e+10])

DUPLICATE_ARRHENIUS_RXN_PARAM_DCT = {LOW_P_RXN: (
                           (LOW_P_PARAMS, None, None, None, None, None),
                           (LOW_P_PARAMS, None, None, None, None, None),)}


DUPLICATE_PLOG_RXN_PARAM_DCT = {HIGH_P_RXN: (
                           (LOW_P_PARAMS, None, None, None,
                               {0.1: [1.04E+15, 0, 59810],
                                1: [1.04E+16, 0, 59810],
                                10: [1.04E+17, 0, 59810],
...
def test__arrhenius():
    ...
    """
    rxn_ktp_dct = rates.eval_rxn_param_dct(ARRHENIUS_RXN_PARAM_DCT, PRESSURES, TEMPS)
    calc_rates = rxn_ktp_dct[LOW_P_RXN]['high'][1]  # the [1] gets the k values
...
def test__lindemann():
    ...
    """
    rxn_ktp_dct = rates.eval_rxn_param_dct(LINDEMANN_RXN_PARAM_DCT, PRESSURES, TEMPS)
    calc_rates = rxn_ktp_dct[HIGH_P_RXN][10][1]  # picking the 10 atm rates
...
def test__troe():
    ...
    """
    rxn_ktp_dct = rates.eval_rxn_param_dct(TROE_RXN_PARAM_DCT, PRESSURES, TEMPS)
    calc_rates = rxn_ktp_dct[HIGH_P_RXN][10][1]  # picking the 10 atm rates
...
def test__plog():
    ...
    """
    rxn_ktp_dct = rates.eval_rxn_param_dct(PLOG_RXN_PARAM_DCT, PRESSURES, TEMPS)
    calc_rates = rxn_ktp_dct[HIGH_P_RXN][0.316][1]  # picking the 0.316 atm rates
...
def test__chebyshev():
    ...
    """
    rxn_ktp_dct = rates.eval_rxn_param_dct(CHEBYSHEV_RXN_PARAM_DCT, PRESSURES, TEMPS2)
    calc_rates = rxn_ktp_dct[HIGH_P_RXN][100][1]  # picking the 100 atm rates
...
def test__dup_arrhenius():
    ...
    """
    rxn_ktp_dct = rates.eval_rxn_param_dct(DUPLICATE_ARRHENIUS_RXN_PARAM_DCT, PRESSURES, TEMPS)
...
def test__dup_plog():
    ...
    """
    rxn_ktp_dct = rates.eval_rxn_param_dct(DUPLICATE_PLOG_RXN_PARAM_DCT, PRESSURES, TEMPS)
    calc_rates = rxn_ktp_dct[HIGH_P_RXN][0.316][1]  # picking the 0.316 atm rates
