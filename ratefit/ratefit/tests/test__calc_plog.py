...
def test__plog_from_single_arrhenius():
    ...
    assert numpy.allclose(plog_ktps[0.1], REF_SGL_PLOG_KTPS[0.1], atol=0.001)
    assert numpy.allclose(plog_ktps[0.5], REF_SGL_PLOG_KTPS[0.5], atol=0.001)
    assert numpy.allclose(plog_ktps[1.0], REF_SGL_PLOG_KTPS[1.0], atol=0.001)
    assert numpy.allclose(plog_ktps[5.0], REF_SGL_PLOG_KTPS[5.0], atol=0.001)
    assert numpy.allclose(plog_ktps[10.0], REF_SGL_PLOG_KTPS[10.0], atol=0.001)
    assert numpy.allclose(plog_ktps[50.0], REF_SGL_PLOG_KTPS[50.0], atol=0.001)
...
def test__plog_from_double_arrhenius():
    ...
    assert numpy.allclose(plog_ktps[0.1], REF_DBL_PLOG_KTPS[0.1], atol=0.001)
    assert numpy.allclose(plog_ktps[0.5], REF_DBL_PLOG_KTPS[0.5], atol=0.001)
    assert numpy.allclose(plog_ktps[1.0], REF_DBL_PLOG_KTPS[1.0], atol=0.001)
    assert numpy.allclose(plog_ktps[5.0], REF_DBL_PLOG_KTPS[5.0], atol=0.001)
    assert numpy.allclose(plog_ktps[10.0], REF_DBL_PLOG_KTPS[10.0], atol=0.001)
    assert numpy.allclose(plog_ktps[50.0], REF_DBL_PLOG_KTPS[50.0], atol=0.001)
