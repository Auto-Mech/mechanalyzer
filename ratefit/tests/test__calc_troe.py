...
def test__calc_three_param():
    ...
    assert set(PRESSURES) <= set(troe3p_ktps.keys())
    assert numpy.allclose(
        troe3p_ktps[0.1][1], REF_TROE3P_KTPS[0.1][1], atol=0.01)
    assert numpy.allclose(
        troe3p_ktps[2.0][1], REF_TROE3P_KTPS[2.0][1], atol=0.01)
    assert numpy.allclose(
        troe3p_ktps[5.0][1], REF_TROE3P_KTPS[5.0][1], atol=0.01)
    assert numpy.allclose(
        troe3p_ktps[10.0][1], REF_TROE3P_KTPS[10.0][1], atol=0.01)
...
def test__calc_four_param():
    ...
    assert set(PRESSURES) <= set(troe4p_ktps.keys())
    assert numpy.allclose(
        troe4p_ktps[0.1][1], REF_TROE4P_KTPS[0.1][1], atol=0.01)
    assert numpy.allclose(
        troe4p_ktps[2.0][1], REF_TROE4P_KTPS[2.0][1], atol=0.01)
    assert numpy.allclose(
        troe4p_ktps[5.0][1], REF_TROE4P_KTPS[5.0][1], atol=0.01)
    assert numpy.allclose(
        troe4p_ktps[10.0][1], REF_TROE4P_KTPS[10.0][1], atol=0.01)
