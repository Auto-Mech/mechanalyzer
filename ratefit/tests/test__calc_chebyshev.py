...
def test__chebyshev():
    ...
    assert set(PRESSURES) <= set(cheb_ktps.keys())
    assert numpy.allclose(
        cheb_ktps[0.1][1], REF_CHEB_KTPS[0.1][1], atol=0.01)
    assert numpy.allclose(
        cheb_ktps[1.0][1], REF_CHEB_KTPS[1.0][1], atol=0.01)
    assert numpy.allclose(
        cheb_ktps[5.0][1], REF_CHEB_KTPS[5.0][1], atol=0.01)
    assert numpy.allclose(
        cheb_ktps[10.0][1], REF_CHEB_KTPS[10.0][1], atol=0.01)
    assert numpy.allclose(
        cheb_ktps[20.0][1], REF_CHEB_KTPS[20.0][1], atol=0.01)
