...
def test__calc():
    ...
    assert set(PRESSURES) <= set(lowp_ktps.keys())
    assert numpy.allclose(
        lowp_ktps[0.5][1], REF_LOWP_KTPS[0.5][1], atol=0.01)
    assert numpy.allclose(
        lowp_ktps[1.0][1], REF_LOWP_KTPS[1.0][1], atol=0.01)
    assert numpy.allclose(
        lowp_ktps[2.0][1], REF_LOWP_KTPS[2.0][1], atol=0.01)
    assert numpy.allclose(
        lowp_ktps[5.0][1], REF_LOWP_KTPS[5.0][1], atol=0.01)
    assert numpy.allclose(
        lowp_ktps[10.0][1], REF_LOWP_KTPS[10.0][1], atol=0.01)
