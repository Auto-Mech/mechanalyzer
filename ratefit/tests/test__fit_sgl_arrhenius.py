...
def test__single_arrhenius_fit_python():
    ...
    test_mean_avg_err = 2.504321595549729
    test_max_avg_err = 7.827700474963309
...
def test__single_arrhenius_fit_dsarrfit():
    ...
    test_mean_avg_err = 2.504192817017522
    test_max_avg_err = 7.82923446743916
