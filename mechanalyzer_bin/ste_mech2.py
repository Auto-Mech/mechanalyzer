...
# noste_rxn_proper_dct = mechanalyzer.builder.remove_improper_reactions(
#     noste_rxn_dct, noste_spc_dct)
...
ste_spc2_dct = mechanalyzer.builder.remove_spc_not_in_reactions(
    ste_rxn_dct, ste_spc_dct)
...
ste_spc_sort_dct = mechanalyzer.parser.spc.reorder_by_atomcount(
    ste_spc2_dct)
csv_str = mechanalyzer.parser.spc.csv_string(ste_spc_sort_dct, HEADERS)

# Write initial string to call the sorter
mech_str = chemkin_io.writer.mechanism.write_chemkin_file(
    elem_tuple=None,
    mech_spc_dct=ste_spc_sort_dct,
    spc_nasa7_dct=None,
